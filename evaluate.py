...
def parse_args():
    ...
    parser.add_argument('--armnn-path', type=str, default=f'{os.path.dirname(os.path.abspath(__file__))}/ArmNN-aarch64/libarmnnDelegate.so', help='Path to ARM NN delegate')
